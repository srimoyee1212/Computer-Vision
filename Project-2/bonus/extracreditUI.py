...
keypointClasses = [('Harris', extracredit.HarrisKeypointDetector),
                   ('ORB', extracredit.ORBKeypointDetector),
                   ('Dummy', extracredit.DummyKeypointDetector)]

# The list of feature descriptors to be presented to the user
descriptorClasses = [('MOPS', extracredit.MOPSFeatureDescriptor),
                     ('ORB', extracredit.ORBFeatureDescriptor),
                     ('Simple', extracredit.SimpleFeatureDescriptor),
                     ('Custom', extracredit.CustomFeatureDescriptor)]

# The list of feature matching algorithms to be presented to the user
matcherClasses = [('Ratio Test', extracredit.RatioFeatureMatcher),
                  ('SSD', extracredit.SSDFeatureMatcher)]
